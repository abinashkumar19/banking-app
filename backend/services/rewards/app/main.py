"""Rewards microservice - generic CRUD against its own DynamoDB table."""
import uuid
...
app = FastAPI(title="VeeraBank Rewards Service", version="1.0.0")
...
def get_item(item_id: str):
    ...
    item = resp.get("Item")
    if not item:
        raise HTTPException(status_code=404, detail="Rewards item not found")
    return item
