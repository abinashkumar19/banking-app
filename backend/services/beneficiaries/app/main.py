"""Beneficiaries microservice - generic CRUD against its own DynamoDB table."""
import uuid
...
SERVICE_NAME = "beneficiaries"
app = FastAPI(title="VeeraBank Beneficiaries Service", version="1.0.0")
...
def get_item(item_id: str):
    ...
    item = resp.get("Item")
    if not item:
        raise HTTPException(status_code=404, detail="Beneficiaries item not found")
    return item
